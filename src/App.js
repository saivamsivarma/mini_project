...
import Recruitercreateprofile from './Pages/Recruiter/Createprofile/Createprofile';
    ...
    <Router>
      <Voicebot/>
        <Switch>
          ...
          <Route path="/recruiter-createprofile" exact component={Recruitercreateprofile}/>
